...
offSet=20;%20
figure(1)
surf(MAdistA(offSet:end),sigmaA(2:end),rmsP(2:end,offSet:end));
ylabel('sigma')
xlabel('\tri M (deg)')
zlabel('RMS')
set(gca,'zscale','log')
...
figure(11)
surf(MAdistA,sigmaA(2:end),rmsP_clip(2:end,:))
ylabel('sigma')
xlabel('\tri M (deg)')
zlabel('RMS')
set(gca,'zscale','log')
...
contour(MAdistA(offSet:end),sigmaA,rmsP(:,offSet:end),vp1,'ShowText','on')
...
figure(3)
hold on;
contour(MAdistA(offSet:end),sigmaA,rmsP(:,offSet:end),vp,'ShowText','on')
%contour3(TAdistA,sigmaA,rmsP)
ylabel('sigma')
xlabel('\tri M (deg)')
zlabel('RMS')
...
figure(4)
hold on;
contour(MAdistA(offSet:end),sigmaA,rmsP(:,offSet:end),vp,'-r','ShowText','on')
...
vp2=[(1:1:9),(10:5:50)];
%contour(TAdistA(offSet:end),sigmaA,rmsP(:,offSet:end),150,'ShowText','on')
contour(MAdistA(offSet:end),sigmaA,rmsEc(:,offSet:end),vp,'-r','ShowText','on')
contour(TAdistA(offSet:end),sigmaA,rmsCir(:,offSet:end),vp,'-k','ShowText','on')
...
%contour(TAdistA(offSet:end),sigmaA,rmsP(:,offSet:end),150,'ShowText','on')
contour(MAdistA(offSet:end),sigmaA,rmsEc(:,offSet:end),vp2,'-r','ShowText','on')
