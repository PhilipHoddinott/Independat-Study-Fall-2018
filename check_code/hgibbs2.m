...
%
%--------------------------------------------------------------------------
function [v2,theta,theta1,copa,error] = hgibbs2(r1,r2,r3,dt21,dt31,dt32)%jd1,jd2,jd3)
%global const
...
%{
term1 = -dt32*( 1/(dt21*dt31) + const.GM_Earth/(12*magr1*magr1*magr1) );
term2 = (dt32-dt21)*( 1/(dt21*dt32) + const.GM_Earth/(12*magr2*magr2*magr2) );
term3 =  dt21*( 1/(dt32*dt31) + const.GM_Earth/(12*magr3*magr3*magr3) );
%}
term1 = -dt32*( 1/(dt21*dt31) + mu/(12*magr1*magr1*magr1) );
term2 = (dt32-dt21)*( 1/(dt21*dt32) + mu/(12*magr2*magr2*magr2) );
term3 =  dt21*( 1/(dt32*dt31) + mu/(12*magr3*magr3*magr3) );
