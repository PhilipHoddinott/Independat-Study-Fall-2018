...
tf31=(Tt/(2*pi))*(MAarr(3)-MAarr(1));%*pi/180;
            ...
            [v2,theta,theta1,copa,error] = hgibbs2(r1,r2,r3,tf21,tf31,tf32);
            v2
             [V2, ierr] = gibbs_Fun(r1, r2, r3,mu);
             V2
keyboard
%}
...
for i=1:length(eArr)
    ...
    xlabel('delta M')
    pntChr(i)={pntBet2};
    strNm=sprintf('tfree_Vsmall_wkspc_i_%d',i);
    save(strNm)
end
